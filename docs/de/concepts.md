...
| :--------------- | :------------------ | :------------------- | :------------------- | :------------ |
| **Docker**       | ✅ `v18` und früher | ✅ `v11` und früher   | ✅ `v9` und früher    | ✅ Unterstützt |
...
!!! info "Hinweise"
    - **PostgreSQL**: Alpine-basierte Pakete enthalten jetzt den `v18`-Client, daher werden `v18` und frühere Versionen standardmäßig unterstützt.
